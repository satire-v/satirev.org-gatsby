...
export type SitePluginPluginOptionsEmitSchema = {
  readonly src___generated___gatsby_introspection_json: Maybe<
    Scalars["Boolean"]
  >;
};
...
export type NavQueryQuery = {
  readonly allDataCategory: {
    readonly nodes: ReadonlyArray<Pick<DataCategory, "name" | "slug" | "id">>;
  };
};
...
export type HeaderQueryQuery = {
  readonly file: Maybe<{
    readonly childImageSharp: Maybe<{
      readonly fixed: Maybe<GatsbyImageSharpFixed_withWebpFragment>;
    }>;
  }>;
};

export type ArticleLinkFragment = Pick<DataArticle, "id" | "slug" | "title"> & {
...
export type ArticleCardFragment = Pick<
  DataArticle,
  "excerpt" | "body" | "tags"
> & { readonly published: DataArticle["created_on"] } & {
  readonly featured_image: Maybe<
    Pick<DataFile, "title"> & {
      readonly data: Maybe<Pick<DataFileData, "full_url">>;
...
export type ArticleFullFragment = Pick<
  DataArticle,
  "tags" | "modified_on" | "featured_image_caption" | "legacy_slug"
> & { readonly year: DataArticle["created_on"] } & ArticleCardFragment;

export type LatestArticlesByCategoryCardsQueryVariables = {};

export type LatestArticlesByCategoryCardsQuery = {
  readonly allDataArticle: {
...
export type LatestArticlesLinksQuery = {
  readonly allDataArticle: {
    readonly nodes: ReadonlyArray<ArticleLinkFragment>;
  };
};

export type TopArticlesLinksQueryVariables = {};

export type TopArticlesLinksQuery = {
  readonly allDataArticle: {
    readonly nodes: ReadonlyArray<ArticleLinkFragment>;
  };
};
...
export type LatestArticleCardQuery = {
  readonly allDataArticle: {
    readonly nodes: ReadonlyArray<ArticleCardFragment>;
  };
};
...
export type FullArticleQuery = {
  readonly dataArticle: Maybe<ArticleFullFragment>;
};
